...
public class DatabaseConnectionSql{
    ...
    private static final String DBURL="jdbc:sqlserver://localhost:1433;DatabaseName=food";
    private static final String DBUSER="zk"; //SQLServer数据库连接用户名
    ...
    public static void main(String[] args) {
        Connection connection = new DatabaseConnectionSql().getConnection();
